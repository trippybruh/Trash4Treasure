...
urlpatterns = [
    ...
    path('signup/user/dash', views.account_overviewer),
    path('signup/user/dash/items', views.account_items_manager),
    ...
    path('dbadmin/flushAllItems', views.deleteAllItems),
    path('dbadmin/flushAllData', views.deleteAllData),

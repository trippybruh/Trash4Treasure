...
def add_random_item(request):
    ...
    cities = ['Alberobello', 'Marsala', 'Pistoia', 'Larciano', 'Busto Arsizio', 'Trieste', 'Roma', 'Viterbo', 'San Severo', 'Ussassai', 'Bologna', 'Napoli']
    ...
    return views.account_overviewer(request, ec=0)
